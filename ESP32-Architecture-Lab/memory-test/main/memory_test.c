...
#include "esp_attr.h"   // ✅ ต้อง include เพื่อใช้ DRAM_ATTR / IRAM_ATTR

// ✅ ใช้ DRAM_ATTR แทน section(".dram")
static DRAM_ATTR char sram_buffer[1024];

// ✅ ไม่ต้องใช้ section(".rodata") เพราะ const จะถูกเก็บใน flash โดยอัตโนมัติอยู่แล้ว
